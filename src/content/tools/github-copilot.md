...
summary: 老牌 AI 编程助手，深度集成 GitHub 生态，企业级合规之选。
category: IDE 插件
...
GitHub Copilot 是最早大规模商用的 AI 编程助手，由 GitHub 与 OpenAI 合作推出。它以插件形式集成到 VS Code、JetBrains、Neovim 等主流编辑器，提供代码补全、对话、多文件改动、PR 评审等能力。凭借与 GitHub 生态的深度集成和企业级合规能力，它是企业团队采用率最高的 AI 编程工具。
...
访问 [github.com/features/copilot](https://github.com/features/copilot)：
- Free：每月 2000 行补全 + 50 次 Chat
- Pro $10/月：无限制补全 + 高级模型
- Business $19/月：团队管理 + 合规
...
- **模型选择**：Pro 版可选 GPT-5 / Claude Opus 4，按任务复杂度切换。
